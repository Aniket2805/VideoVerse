...
const SearchResultVideoCard = ({ video }) => {
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className='flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.2] rounded-xl md:p-4'>
        <div className='relative flex shrink-0 h-48 md:h-28 lg:h-40 xl:h-48 md:w-90 rounded-xl bg-purple-600 overflow-hidden'>
