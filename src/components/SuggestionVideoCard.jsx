  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className='flex mb-3'>
        <div className='relative h-24 lg:20 xl:24 w-40 min-w-[168px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-xl bg-slate-800 overflow-hidden'> 
        ...
        <div className='flex flex-col ml-3 overflow-hidden'>
          ...
          <span className='text-[12px] lg:text-[10px] xl:text-[12px] font-semibold mt-2 text-white/[0.7] flex items-center'>
            ...
            {video?.author?.badges[0]?.type === "VERIFIED_CHANNEL" &&
              <BsFillCheckCircleFill className='text-white/[0.5] text-[12px] lg:text-[10px] xl:text-[12px] ml-1'></BsFillCheckCircleFill>}
          </span>
